...
public class UFMLoginExcelTest {
	...
	@Test(dataProvider = "excelinputs", dataProviderClass = LoginDataProviders.class)
...
//		loginPOM.clickLoginBtn();
		...
		UniformLoginPagePOM.sendEmailAdd(userName);
		UniformLoginPagePOM.sendPassword(password);
