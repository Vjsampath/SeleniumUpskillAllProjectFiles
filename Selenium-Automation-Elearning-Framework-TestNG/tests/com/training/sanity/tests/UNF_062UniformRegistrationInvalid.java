...
public class UNF_062UniformRegistrationInvalid {
	...
	@Test(dataProvider = "excelreginvalidinputs", dataProviderClass = LoginDataProviders.class)
...
//		System.out.println("Assert Acct Creation Pass");
		screenShot.captureScreenShot("UNF_062UniformReg Error message");
		
	} catch( Exception e) { System.out.print("exception thrown and Registration not successfull"); }
}
